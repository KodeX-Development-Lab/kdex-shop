                            ...
                            <div class="row mb-3">
                                <div class="col-md-2">
                                    <select name="" class=" form-control select2" id="month">
                                        ...
                                        <option value="03" @if (now()->format('m') == '03') selected @endif>March
                                        </option>
                                        <option value="04" @if (now()->format('m') == '04') selected @endif>April
                                        </option>
                                        <option value="05" @if (now()->format('m') == '05') selected @endif>May
                                        </option>
                                        <option value="06" @if (now()->format('m') == '06') selected @endif>June
                                        </option>
                                        <option value="07" @if (now()->format('m') == '07') selected @endif>July
                                        </option>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-control select2" id="year">
                                        ...
                                        @foreach ($years as $year)
                                            <option value="{{ $year }}"
                                                @if (now()->format('Y') == $year) selected @endif>{{ $year }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                function fetchData() {
                    ...
                    $.ajax({
                        url: `attendance-overview-table-filter?userName=${userName}&month=${month}&year=${year}`,
                        type: 'GET',
