            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class=" d-flex">
                            <!-- create modal -->
                            @include('components.ecommerce.Brand.createForm')
                            @include('components.ecommerce.Brand.updateForm')
                            <div class="">
...
@endsection
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\createBrandRequest', '#create') !!}
    {!! JsValidator::formRequest('App\Http\Requests\updateBrandRequest', '#update') !!}
    <script>
        $(document).ready(function() {

            var table = new DataTable('#example', {
                ajax: 'dataTable/brand',
                mark: true,
                responsive: true,
                processing: true,
                serverSide: true,
